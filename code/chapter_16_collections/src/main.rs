...
fn main() {
    ...
    let text = "Contrary to popular belief, Lorem Ipsum is not simply random text. 
    ...
    The first line of Lorem Ipsum, Lorem ipsum dolor sit amet.., comes from a line in section 1.10.32.".to_string();
